...
module.exports.onChat = async ({
    ...
    try {
        ...
        const extraGalikhor = [
            ...
            "লুন্ড", "পেনিস", "ভিরা", "ধোন", "বীর্য", "যোনি", "বস্তা", "থলি"
        ];
        ...
        if (body === "fool" || body === "pagol" || body === "boka" || body === "মূর্খ" || body === "পাগল" || body === "বোকা") {
            const ironyReplies = [
                "Fool er sathe kotha bolchi naile? 😏",
                "Bokar kotha sunte onek moja! 😂",
                "Pagol bole dekhlam, paglami to tomar 😎",
        ...
        if (body === "noob" || body === "নুব" || body === "Noob") {
            const noobReplies = [
                "Noob bolte gele tomar kache sikhte hobe 😏",
                "Noob? Hehe, at least ami AI to 😎",
                "Noob na bole pro bolun ✨",
                "নুব না বলে স্যার বলুন 😜",
                "Noob তো আমিই, আপনি তো pro! 😂"
            ];
            return api.sendMessage(noobReplies[Math.floor(Math.random() * noobReplies.length)], event.threadID, event.messageID);
        }
